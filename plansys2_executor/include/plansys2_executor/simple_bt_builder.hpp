...
#ifndef PLANSYS2_BT_BUILDER_PLUGINS__SIMPLE_BT_BUILDER_HPP_
#define PLANSYS2_BT_BUILDER_PLUGINS__SIMPLE_BT_BUILDER_HPP_
...
{
public:
  explicit SimpleBTBuilder();
  void initialize(const std::string & bt_action = "");
...
#endif  // PLANSYS2_BT_BUILDER_PLUGINS__SIMPLE_BT_BUILDER_HPP_
